...
const MONGO_URI =
  ...
  "mongodb://127.0.0.1:27017/betalningsapp";
...
async function sendInvoiceEmail(
  ...
  const pdfBuffer =
    await createInvoicePdfBuffer(invoice);
...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      res.status(500).json({
        message:
          "Kunde inte skicka alla påminnelser",
...
app.post(
  "/api/invoices/:id/create-checkout-session",
